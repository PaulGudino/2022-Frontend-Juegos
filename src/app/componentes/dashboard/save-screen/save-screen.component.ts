  ...
  updateSaveScreen(){
   ...
   this.dialogService.confirmed().subscribe(confirmed => {
      if(confirmed && this.fileToUpload){
         ...
         formData.append('video_screensaver', this.dashStyle.getVideoScreensaverFile(), this.dashStyle.getVideoScreensaverFile().name);
         formData.append('title_button_screensaver',this.buttonTitle)
         formData.append('color_background_game',this.dashStyle.get_color_background_game())
         formData.append('color_text',this.dashStyle.get_color_text())
         formData.append('title_winner',this.dashStyle.get_title_winner())
         formData.append('description_winner',this.dashStyle.get_description_winner())
